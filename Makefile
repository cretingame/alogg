...
ifeq ($(DEBUG),1)
CFLAGS+=-g -DDEBUGMODE -DDEBUG -DFORTIFY -fno-builtin
LIBS+=-lfortify
...
LIBALLOG_OBJS = $(BASEBINNAME).o
ifneq ($(CURL),)
LIBALLOG_OBJS += $(BASEBINNAME)url.o
endif
ifneq ($(PTHREAD),)
LIBALLOG_OBJS += $(BASEBINNAME)pth.o
endif

$(BASELIBNAME).a: $(LIBALLOG_OBJS)
	ar cr $(BASELIBNAME).a $(LIBALLOG_OBJS)
